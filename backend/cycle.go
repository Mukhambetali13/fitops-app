...
var Workouts = map[string]WorkoutMeta{
	"recovery":            {"Восстановление & Стретчинг", "15–20 мин"},
	"cardio_light":        {"Лёгкое кардио", "20–30 мин"},
	"brisk_walking":       {"Быстрая ходьба (Power Walking)", "30–45 мин"},
	"legs":                {"Legs: Ноги + кор", "50–60 мин"},
	"active_rest":         {"Активное восстановление", "15 мин"},
	"recovery_full":       {"Сон и полное восстановление", "по самочувствию"},
	"push":                {"Push: Грудь / плечи / трицепс", "55–65 мин"},
	"pull":                {"Pull: Спина / бицепс / пресс", "55–65 мин"},
	"legs_full":           {"Legs Heavy: Ноги + метаболический круг", "60 мин"},
	"fullbody_a":          {"Full Body A: Сила & База", "50–60 мин"},
	"fullbody_b":          {"Full Body B: Баланс & Задняя цепь", "50–60 мин"},
	"fullbody_express":    {"Full Body Экспресс (30 мин)", "25–35 мин"},
	"fullbody_functional": {"Full Body Функциональный & Кор", "40–45 мин"},
}
